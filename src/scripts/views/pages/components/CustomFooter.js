...
<li class="ms-3"><a class="text-body-secondary" href="https://instagram.com/anggraenideaaa" ><i class="bi bi-instagram" target="_blank"><i class="fa-brands fa-square-instagram fa-2xl icon-ig" ></i></a></li>
                </ul>
              </footer>
            </div>
        `;
